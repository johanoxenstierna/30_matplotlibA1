        ...
        if _s.drawn == 0:  # not drawn, for some reason this is necessary to keep
            ...
            if o2 == False:
                if _s.o0.id == 'projectiles':
                    ...
                    axs0.append(ax0.imshow(_s.pic, zorder=_s.gi['zorder'], alpha=0, origin='lower',
                ...
                if _s.o0.id == 'projectiles':
                    ...
                    axs0.append(ax0.plot(_s.xy[0, 0], _s.xy[0, 1], zorder=_s.gi['zorder'],
                                         alpha=0.5, color='turquoise', marker='o', markersize=10)[0])
                elif _s.o0.id == 'clouds':
                    pass
